...
const layout: ViewLayout[] = [
  {
    ...
    nodes: [
      ...
      n('web', 'web', 390, 240, 220),
      n('servidor', 'servidor', 790, 240, 230),
      n('fabrica', 'fabrica', 1220, 240, 220),
  ...
  },
  {
    ...
    nodes: [
      ...
      n('p4', 'paso', 980, 140, 210),
      n('p5', 'paso', 1290, 140, 210),
      n('carrito', 'datos', 660, 400, 210),
      n('pedido', 'servidor', 980, 400, 210),
      n('vidrios', 'web', 40, 400, 210),
      n('revendedor', 'persona', 1290, 400, 210),
      n('e1', 'estado', 40, 690, 150),
      n('e2', 'estado', 260, 690, 150),
      n('e3', 'paso', 490, 690, 150),
      n('e4', 'estado', 720, 690, 150),
      n('e5', 'estado', 940, 690, 170),
      n('e6', 'estado', 1190, 690, 170),
      n('e7', 'ok', 1440, 620, 140),
      n('e8', 'bad', 1440, 760, 140),
      n('e9', 'bad', 1650, 620, 140),
      n('e10', 'bad', 1650, 760, 140),
    ],
    groups: [
  ...
  },
  {
    id: 'precio',
    nodes: [
      n('in1', 'entrada', 40, 90, 250),
      n('in2', 'entrada', 400, 90, 250),
      n('in3', 'entrada', 760, 90, 250),
      n('in4', 'entrada', 1130, 90, 250),
      n('gate', 'gate', 1540, 90, 240),
      n('prox', 'gate', 1540, 390, 240),
      n('s1', 'calc', 40, 400, 210),
      n('s2', 'calc', 340, 400, 210),
      n('s3', 'calc', 640, 400, 210),
      n('s4', 'calc', 940, 400, 210),
      n('s5', 'calc', 1240, 400, 210),
      n('t1', 'total', 40, 710, 250),
      n('t2', 'total', 400, 710, 250),
      n('t3', 'total', 760, 710, 250),
      n('t4', 'total', 1130, 710, 250),
    ],
    groups: [
  ...
  },
  {
    ...
    nodes: [
      ...
      n('pw', 'panel', 490, 530, 300),
      n('sem', 'gate', 490, 720, 300),
      n('web', 'web', 490, 920, 300),
      n('k1', 'config', 1060, 90, 240),
      n('k2', 'config', 1060, 230, 240),
      n('k3', 'config', 1060, 380, 240),
      n('k4', 'config', 1060, 520, 240),
      n('k5', 'config', 1060, 660, 240),
      n('k6', 'config', 1060, 810, 240),
      n('pedidos', 'fabrica', 1060, 980, 240),
    ],
    groups: [
  ...
  },
  {
    id: 'fabrica',
    nodes: [
      n('f1', 'servidor', 40, 180, 220),
      n('f2', 'servidor', 390, 180, 220),
      n('f3', 'panel', 740, 180, 220),
      n('f4', 'panel', 1090, 180, 220),
      n('f5', 'fabrica', 1440, 180, 220),
      n('g1', 'datos', 40, 510, 260),
      n('g2', 'persona', 460, 510, 260),
      n('g3', 'gate', 1060, 510, 260),
      n('g4', 'fabrica', 1440, 510, 240),
    ],
